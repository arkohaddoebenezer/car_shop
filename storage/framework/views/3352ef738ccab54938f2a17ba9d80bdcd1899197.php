            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="section-title">
                        <h2>Available</h2>
                        <p>Buy, Rent or Swap car within 24hours .</p>
                    </div>
                </div>
            </div>
            <div class="row">
                                    ...
                                    <div class="thumb-content">
                                        ...
                                        <a href="single.html">
                                            <img class="card-img-top img-fluid"
                                                src="<?php echo e(asset('images/products/car2.png')); ?>" alt="Card image cap">
                                        </a>
                                    </div>
                                    <div class="card-body">
            ...
            <div class="row justify-content-md-center text-center">
                <div class="col-md-8">
                    <div class="content-holder">
                        <h2>Add your car for rent,buying or swapping or browse available cars  </h2>
...
<?php echo $__env->make('layouts.users', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\car_shop\resources\views/users/welcome.blade.php ENDPATH**/ ?>