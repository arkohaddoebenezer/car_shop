                        ...
                        <div class="short-popular-category-list text-center">
                            ...
                            <ul class="list-inline">
                                <li class="list-inline-item">
                                    <a href="category.html"><i class="fa fa-car"></i> Bus</a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="category.html"><i class="fa fa-car"></i> Luxury </a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="category.html"><i class="fa fa-car"></i> Pick up</a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="category.html"><i class="fa fa-car"></i>SUV</a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="category.html"><i class="fa fa-car"></i> Mini Van</a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="category.html"><i class="fa fa-car"></i> Pick Up</a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="category.html"><i class="fa fa-car"></i> Sport Car</a>
                                </li>
                            </ul>
                        </div>
                                ...
                                <div class="card">
                                    <div class="thumb-content">
                                        ...
                                        <a href="{{ route('details') }}">
                                            <img class="card-img-top img-fluid" src="{{ asset('media/car2.png') }}"
                                                alt="Card image cap">
                                        </a>
                                    </div>
                                    <div class="card-body">
                                        <h4 class="card-title"><a href="{{ route('details') }}">11inch Macbook Air</a>
                                        </h4>
                                        <ul class="list-inline product-meta">
                                            <li class="list-inline-item">
                                                <a href="{{ route('details') }}"><i
                        ...
                        <div class="col-sm-12 col-lg-4">
                            ...
                            <div class="product-item bg-light">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <h4 class="card-title"><a href="{{ route('details') }}">Full Study Table
                                                Combo</a>
                                        </h4>
                                        <ul class="list-inline product-meta">
                                            <li class="list-inline-item">
